...
<html>
	<head>
		<title>{{ $application->user->name }} responded to you on Preditc</title>
									...
									<tr>
										...
										>
											...
											<p
												...
												"
											>
												Here's what {{ $application->user->name }} has to say about {{ $application->coin->name }} in the {{ $application->time }}-term future
											</p>
											<p
												style="
													font-size: 16px;
													...
													color: #000;"
											>
												{{ $application->responses[0]->response }}
											</p>
											<p
												style="
													font-size: 16px;
